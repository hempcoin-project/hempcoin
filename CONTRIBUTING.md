Contributing to Hempcoin Core
============================

The Hempcoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Hempcoin Core project, and is not to be
confused with overall Hempcoin Network Protocol consensus changes.

Whether a pull request is merged into Hempcoin Core rests with the project merge
...
Patches that change Hempcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Hempcoin consensus, it must have been
...
The project leader is the release manager for each Hempcoin Core release.
