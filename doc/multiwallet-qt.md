...
In order to support loading of multiple wallets in hempcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is hempcoin.cpp.
...
Changes to hempcoin.cpp
----------------------
hempcoin.cpp is the entry point into hempcoin-qt, and as such, will require some minor modifications to provide hooks for
