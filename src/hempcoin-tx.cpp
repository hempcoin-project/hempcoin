...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Hempcoin Core hempcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  hempcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded hempcoin transaction") + "\n" +
                               "  hempcoin-tx [options] -create [commands]   " + _("Create hex-encoded hempcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded hempcoin transaction
