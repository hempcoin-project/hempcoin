                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Hempcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and hempcoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Hempcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Hempcoin Core"));
    ...
    openAction->setStatusTip(tr("Open a Hempcoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Hempcoin Core help message to get a list with possible Hempcoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Hempcoin Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Hempcoin Core"); // default title
