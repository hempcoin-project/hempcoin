...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Hempcoin Core"),
     ...
     * override -datadir in the hempcoin.conf file in the default data directory
     * (to be consistent with hempcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
