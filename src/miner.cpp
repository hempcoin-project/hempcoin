...
bool ProcessBlockFound(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    if (!ProcessNewBlock(state, NULL, pblock))
        return error("HempcoinMiner : ProcessNewBlock, block not accepted");
...
{
    LogPrintf("HempcoinMiner started\n");
    ...
    while (fGenerateBitcoins || fProofOfStake) {
        ...
        LogPrintf("Running HempcoinMiner with %u transactions in block (%u bytes)\n", pblock->vtx.size(),
