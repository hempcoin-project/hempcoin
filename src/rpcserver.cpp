...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Hempcoin features */
        {"hempcoin", "masternode", &masternode, true, true, false},
        {"hempcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"hempcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"hempcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"hempcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"hempcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"hempcoin", "startmasternode", &startmasternode, true, true, false},
        {"hempcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"hempcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"hempcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"hempcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"hempcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"hempcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"hempcoin", "mnbudget", &mnbudget, true, true, false},
        {"hempcoin", "preparebudget", &preparebudget, true, true, false},
        {"hempcoin", "submitbudget", &submitbudget, true, true, false},
        {"hempcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"hempcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"hempcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"hempcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"hempcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"hempcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"hempcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"hempcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"hempcoin", "mnsync", &mnsync, true, true, false},
        {"hempcoin", "spork", &spork, true, true, false},
        {"hempcoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"hempcoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use hempcoind, or the -server option to hempcoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> hempcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:27777/\n";
}
