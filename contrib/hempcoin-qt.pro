...
RESOURCES += src/qt/hempcoin.qrc src/qt/hempcoin_locale.qrc

TRANSLATIONS += src/qt/locale/hempcoin_bg.ts \
                src/qt/locale/hempcoin_de.ts \
                src/qt/locale/hempcoin_en.ts \
                src/qt/locale/hempcoin_es.ts \
                src/qt/locale/hempcoin_fi.ts \
                src/qt/locale/hempcoin_fr.ts \
                src/qt/locale/hempcoin_it.ts \
                src/qt/locale/hempcoin_ja.ts \
                src/qt/locale/hempcoin_pl.ts \
                src/qt/locale/hempcoin_pt.ts \
                src/qt/locale/hempcoin_ru.ts \
                src/qt/locale/hempcoin_sk.ts \
                src/qt/locale/hempcoin_sv.ts \
                src/qt/locale/hempcoin_vi.ts \
                src/qt/locale/hempcoin_zh_CN.ts \
                src/qt/locale/hempcoin_zh_TW.ts
